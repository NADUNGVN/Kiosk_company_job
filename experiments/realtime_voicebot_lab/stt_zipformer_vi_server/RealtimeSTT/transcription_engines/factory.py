...
ENGINE_CLASS_PATHS = {
    ...
    "sherpa_onnx_zipformer": (".sherpa_onnx_engine", "SherpaOnnxZipformerEngine"),
    "sherpa_zipformer": (".sherpa_onnx_engine", "SherpaOnnxZipformerEngine"),
    "zipformer_sherpa_onnx": (".sherpa_onnx_engine", "SherpaOnnxZipformerEngine"),
    "zipformer": (".sherpa_onnx_engine", "SherpaOnnxZipformerEngine"),
